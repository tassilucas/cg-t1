...
function contornaArea1(){
  for(let z=0; z<32; z = z + 2){
    addCube(-24, -2, -35-z, false, colorOutline, edgeOutline, 2, 2, 2, 2);
    addCube(26, -2, -35-z, false, colorOutline, edgeOutline, 2, 2, 2, 2);
  }

  for(let x=0; x<22; x = x + 2){
    addCube(x+4, -2, -35, false, colorOutline, edgeOutline, 2, 2, 2, 2);
    addCube(-x-4, -2, -35, false, colorOutline, edgeOutline, 2, 2, 2, 2);
    addCube(x+4, -2, -65, false, colorOutline, edgeOutline, 2, 2, 2, 2);
    addCube(-x-4, -2, -65, false, colorOutline, edgeOutline, 2, 2, 2, 2);
  }
}

function contornaArea2(){
  for(let x=0; x<22; x = x + 2){
    addCube(x+5, 4, 35, false, colorOutline, edgeOutline, 2, 2, 2, 2);
    addCube(-x-3, 4, 35, false, colorOutline, edgeOutline, 2, 2, 2, 2);
    addCube(x+5, 4, 65, false, colorOutline, edgeOutline, 2, 2, 2, 2);
    addCube(-x-3, 4, 65, false, colorOutline, edgeOutline, 2, 2, 2, 2);
  }

  addCube(-25, 4, 35, false, colorOutline, edgeOutline, 2, 2, 2, 2);
  addCube(-25, 4, 65, false, colorOutline, edgeOutline, 2, 2, 2, 2);

  for(let z=0; z<32; z = z + 2){
    addCube(-25, 4, z+35, false, colorOutline, edgeOutline, 2, 2, 2, 2);
    addCube(25, 4, z+35, false, colorOutline, edgeOutline, 2, 2, 2, 2);
  }
}

function contornaArea3(){
  for(let x=0; x<52; x=x+2)
    addCube(x+38, -2, 28, false, colorOutline, edgeOutline, 2, 2, 2, 2);

  for(let z=0; z<26; z=z+2){
...
function area2Setup(){
  ...
  area2Bridge = addCube(1, 3.35, 65, false, "#ff0fff", "#ff0fff", 6, 5, 2, 2);
...
function area3Setup(){
  ...
  // Stairs
  addCube(35, -4, -1, false, colorStairs, edgeStairs, 14, 1, 4, 2);
  ...
  spotLight.target.position.set(93, 0, 0);
  ...
  // Key area ->> adding the key bridge
  area3Bridge = addCube(88, -3, 0, false, "#ff0fff", "#ff0fff", 6, 5, 2, 2);
